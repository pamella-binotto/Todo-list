      ...
      <div className={` ${themeConfig[theme].todo.backgroundColor} rounded-md`}>
        ...
        <div className={` text-sm flex justify-between p-4 ${themeConfig[theme].layout.textColor} `}>
          ...
          <div className="hidden sm:flex gap-4 ">
            ...
            <button onClick={() => setFilter("active")} className={` ${filter === "active" ? 'text-bright-blue ' : '' } 
            cursor-pointer ${theme === "dark" ? "hover:text-neutral-light-grayish-blue-hover" : "hover:text-neutral-very-dark-grayish-blue"} `} >Active</button>
